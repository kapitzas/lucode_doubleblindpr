...
# File paths
figure_path <- "~/papers/2020_lu_model/GEB/figures"
...
boundary <- readOGR("~/data/bnd_ama/Lim_Biogeografico.shp") # Study aarea boundary feature
...
# South America
sa <- readOGR("~/Global/countries_shp/countries.shp")
